...
<body class="bg-gradient-to-r from-blue to-color-F4F2DE">
                        ...
                        <div class="space-y-5 rounded-full shadow-sm">
                            <div>
                                ...
                                <input id="username" name="username" type="text" required
                                    class="relative block w-full rounded-full border-0 py-2 text-black placeholder:text-black placeholder:opacity-50 sm:text-sm sm:leading-6 px-3 text-black"
