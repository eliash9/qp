...
class AdminController extends Controller
{
    public function index()
    {
        ...
        // Menghitung persentase jawaban dengan nilai 1 dari tabel answers
        $answerPercentage = $this->calculateAnswerPercentage();

        return view('admin.index', compact('tableCounts', 'answerPercentage'));
    }

    private function getTableCounts()
    {
        $tableCounts = [];
        $tables = ['rooms', 'quiz', 'users'];
    ...
    private function calculateAnswerPercentage()
    {
        ...
        $percentage = ($totalWithScore1 / $totalRows) * 100;
